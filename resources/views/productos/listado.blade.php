...
<div class="container">
    <div class="col-md-12">
        ...
        <a class="btn btn-info" href="{{ action([App\Http\Controllers\ProductosController:: class, 'formulario']) }}">Agregar producto</a>
        <table class="table table-bordered table-hover">
            ...
            <tr>
                <td><a href="{{ action([App\Http\Controllers\ProductosController:: class, 'formulario'],['id'=>$registro->id]) }}">{{ $registro->nombre }}</a></td>
            </tr>
            @endforeach
            </tbody>
        </table>
